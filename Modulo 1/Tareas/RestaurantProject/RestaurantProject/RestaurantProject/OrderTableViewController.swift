...
class OrderTableViewController: UITableViewController, AddToOrderDelegate {
    ...
    @IBAction func submitButtonTapped(_ sender: UIBarButtonItem) {
        ...
        let alert = UIAlertController(title: "Confirm Order", message: "You're about to submit your order with a total of \(formattedOrder)", preferredStyle: .alert)
    ...
    @IBAction func unwindToOrderList(segue: UIStoryboardSegue){
        if segue.identifier == "DissmisConfirmation"{
            menuItems.removeAll()
